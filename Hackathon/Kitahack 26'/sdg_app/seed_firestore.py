...
# ── Initialize Firebase ────────────────────────────────────────────────────────
# Replace with path to your Firebase service account JSON key
    ...
    events = [
        {
            ...
            "address": "Jalan Klang Lama, Kuala Lumpur", "date": now + timedelta(days=7),
        ...
        },
        {
            ...
            "address": "Jalan Chow Kit, Kuala Lumpur", "date": now + timedelta(days=3),
        ...
        },
        {
            ...
            "address": "Petaling Jaya Community Hall", "date": now + timedelta(days=14),
        ...
        },
        {
            ...
            "address": "Petaling Jaya, Selangor", "date": now + timedelta(days=10),
