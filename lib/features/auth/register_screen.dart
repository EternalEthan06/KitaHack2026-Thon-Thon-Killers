      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('Join the SDG\nMovement 🌍', style: Theme.of(context).textTheme.headlineLarge),
              ...
              TextField(controller: _emailCtrl, keyboardType: TextInputType.emailAddress, decoration: const InputDecoration(hintText: 'Email address')),
              const SizedBox(height: 12),
              TextField(controller: _passCtrl, obscureText: true, decoration: const InputDecoration(hintText: 'Password (min. 6 chars)')),
              ...
              SdgButton.primary(label: _loading ? 'Creating account...' : 'Create Account', onPressed: _loading ? null : _register),
