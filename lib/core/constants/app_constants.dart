class AppConstants {
  ...
  // Scoring thresholds
  // Scoring & Multipliers
  static const int streakMultiplierThreshold = 15; // 15 days = bonus
  static const double maxMultiplier = 5.0;

  // Reward costs (RM5 TnG = 1000 pts)
  static const int rewardVoucherCost = 1000;
  static const int rewardTreeCost = 600;
  static const int rewardBadgeCost = 200;
